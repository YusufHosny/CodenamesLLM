from .codenames import (
  CodeNamesAction, CodeNamesActionType, CodeNamesGameState, CodeNamesGuesserInterface,
  CodeNamesPlayerInterface, CodeNamesSpyMasterInterface, CodeNamesWordType
)
...
class CLICodeNamesPlayer(CodeNamesPlayerInterface):
  ...
  def print_gamestate(self):
    print(f"\nYour turn ({self.name}):")
    self.game_state.pprint(show_colors=self.show_colors)
